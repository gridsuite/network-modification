...
public class LineCreation extends AbstractModification {
    ...
    private void addLine(Network network, VoltageLevel voltageLevel1, VoltageLevel voltageLevel2, LineCreationModel lineCreationInfos, boolean withSwitch1, boolean withSwitch2,
