...
public class EquipmentAttributeModification extends AbstractModification {
    ...
    public void check(Network network) throws NetworkModificationException {
        ...
        if (identifiable.getType() != modificationModel.getEquipmentType()) {
            throw new NetworkModificationException(WRONG_EQUIPMENT_TYPE,
                String.format("Type of '%s' is not %s but %s", modificationModel.getEquipmentId(), modificationModel.getEquipmentType(), identifiable.getType()));
        }
    }
    ...
    public void apply(Network network, ReportNode subReportNode) {
        ...
        if (identifiable instanceof Switch) {
            ...
            if (identifiable instanceof Line) {
                ...
                changeTwoWindingsTransformerAttribute((TwoWindingsTransformer) identifiable,
                    modificationModel.getEquipmentAttributeName(), modificationModel.getEquipmentAttributeValue(), subReportNode);
            }
        } else if (identifiable instanceof ThreeWindingsTransformer) {
            changeThreeWindingsTransformerAttribute((ThreeWindingsTransformer) identifiable,
                modificationModel.getEquipmentAttributeName(), modificationModel.getEquipmentAttributeValue(), subReportNode);
