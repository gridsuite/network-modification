...
public class TwoWindingsTransformerCreation extends AbstractModification {
    ...
    private TwoWindingsTransformerAdder createTwoWindingsTransformerAdder(VoltageLevel voltageLevel1, VoltageLevel voltageLevel2,
            TwoWindingsTransformerCreationModel twoWindingsTransformerCreationInfos, boolean withSwitch1, boolean withSwitch2) {
    ...
    private void addTapChangersToTwoWindingsTransformer(Network network, TwoWindingsTransformerCreationModel twoWindingsTransformerCreationInfos, TwoWindingsTransformer twt,
    ...
    private void addPhaseTapChangersToTwoWindingsTransformer(Network network, TwoWindingsTransformerCreationModel twoWindingsTransformerCreationInfos, TwoWindingsTransformer twt,
            ReportNode subReportNode) {
    ...
    private void addRatioTapChangersToTwoWindingsTransformer(Network network, TwoWindingsTransformerCreationModel twoWindingsTransformerCreationInfos, TwoWindingsTransformer twt,
            ReportNode subReportNode) {
        List<ReportNode> regulatedTerminalReports = new ArrayList<>();
        List<ReportNode> regulationReports = new ArrayList<>();
        List<ReportNode> tapsReports = new ArrayList<>();
    ...
    private void create2WTInOtherBreaker(Network network, VoltageLevel voltageLevel1, VoltageLevel voltageLevel2, TwoWindingsTransformerCreationModel twoWindingsTransformerCreationInfos,
