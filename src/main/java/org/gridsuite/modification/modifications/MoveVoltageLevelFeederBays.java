    ...
    private BranchModificationModel buildBranchModificationModel(MoveFeederBayModel info) {
        ...
        switch (connectionSide) {
            ...
            case TWO -> setConnectionAttributes(branchModel::setConnectionPosition2,
                    ...
                    info);
            default -> throw new NetworkModificationException(MOVE_VOLTAGE_LEVEL_FEEDER_BAYS_ERROR, String.format(INVALID_CONNECTION_SIDE, info.getConnectionSide(), branchModel.getEquipmentId()));
        }
        return branchModel;
    }
