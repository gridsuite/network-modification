...
public class OperationalLimitsGroupsModification {
    ...
    private void detectApplicabilityChange(OperationalLimitsGroupModificationModel modifiedLimitSetModel, List<ReportNode> olgReports) {
        ...
        switch (modifiedLimitSetModel.getApplicability()) {
            case SIDE1 ->
                moveLimitSetToTheOtherSide(modifiedBranch, limitsGroup2, modifiedLimitSetModel.getId(), true, olgReports);
            case SIDE2 ->
                moveLimitSetToTheOtherSide(modifiedBranch, limitsGroup1, modifiedLimitSetModel.getId(), false, olgReports);
            case EQUIPMENT -> {
