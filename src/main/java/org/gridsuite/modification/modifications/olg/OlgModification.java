...
public class OlgModification {
    ...
    public void removeOlg() {
        ...
        if (modifySide1() && modifiedBranch.getOperationalLimitsGroup1(olgId).isEmpty() ||
            modifySide2() && modifiedBranch.getOperationalLimitsGroup2(olgId).isEmpty()) {
