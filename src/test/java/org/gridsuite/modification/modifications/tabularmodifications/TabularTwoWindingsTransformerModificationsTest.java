...
class TabularTwoWindingsTransformerModificationsTest extends AbstractNetworkModificationTest {
    ...
    private void assertAfterNetworkModificationApplication(ReportNode reportNode) {
        ...
        assertLogMessageWithoutRank("Tabular modification: 2 two windings transformers have been modified and 1 have not been modified", "network.modification.tabular.modification.partial",
                reportNode);
    }
