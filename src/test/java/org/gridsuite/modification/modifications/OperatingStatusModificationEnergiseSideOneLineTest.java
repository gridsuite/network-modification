...
class OperatingStatusModificationEnergiseSideOneLineTest extends AbstractNetworkModificationTest {
    ...
    protected void checkModification() {
        ...
        assertEquals(OPERATING_STATUS_MODIFICATION_ERROR.getMessage() + " : Unable to energise equipment end", exception.getMessage());
    ...
    void testCreateSubReportNode() {
        ...
        assertLogMessage("Energise " + TARGET_LINE_ID, "network.modification.OPERATING_STATUS_MODIFICATION_ENERGISE_END_ONE", reportNode);
    }
}
