...
class LineModificationTest extends AbstractNetworkModificationTest {
    ...
    private static final String LIMITS_PROP1_NAME = "limitProperyName1";
    private static final String LIMITS_PROP1_VALUE = "limitProperyValue1";
    private static final String LIMITS_PROP2_NAME = "limitProperyName2";
    private static final String LIMITS_PROP2_VALUE = "limitProperyValue2";
    private static final String LIMITS_PROP3_NAME = "limitProperyName3";
    private static final String LIMITS_PROP3_VALUE = "limitProperyValue3";
    ...
    void testLimitsPropertiesModificationDifferentOperationalLimits() {
        ...
        limitsGroup1.setProperty(LIMITS_PROP1_NAME, LIMITS_PROP1_VALUE);
        ...
        limitsGroup2.setProperty(LIMITS_PROP1_NAME, LIMITS_PROP1_VALUE);
        limitsGroup2.setProperty(LIMITS_PROP2_NAME, LIMITS_PROP2_VALUE);
        ...
        OperationalLimitsGroupModificationInfos opLimitsGroupInfos1 = OperationalLimitsGroupModificationInfos.builder()
            ...
            .limitsProperties(List.of(new LimitsPropertyInfos(LIMITS_PROP2_NAME, LIMITS_PROP2_VALUE))).build();

        OperationalLimitsGroupModificationInfos opLimitsGroupInfos2 = OperationalLimitsGroupModificationInfos.builder()
            .id("NewLimitsGroup").applicability(SIDE2).modificationType(MODIFY_OR_ADD)
            .currentLimits(CurrentLimitsModificationInfos.builder().permanentLimit(10.0).build())
            .limitsProperties(List.of(new LimitsPropertyInfos(LIMITS_PROP1_NAME, OTHER_VALUE),
                new LimitsPropertyInfos(LIMITS_PROP3_NAME, LIMITS_PROP3_VALUE))).build();
        ...
        assertTrue(limitsGroup1.hasProperty(LIMITS_PROP2_NAME));
        assertFalse(limitsGroup1.hasProperty(LIMITS_PROP1_NAME));
        assertEquals(LIMITS_PROP2_VALUE, limitsGroup1.getProperty(LIMITS_PROP2_NAME));

        assertEquals(2, limitsGroup2.getPropertyNames().size());
        assertTrue(limitsGroup2.hasProperty(LIMITS_PROP1_NAME));
        assertTrue(limitsGroup2.hasProperty(LIMITS_PROP3_NAME));
        assertFalse(limitsGroup2.hasProperty(LIMITS_PROP2_NAME));
        assertEquals(OTHER_VALUE, limitsGroup2.getProperty(LIMITS_PROP1_NAME));
        assertEquals(LIMITS_PROP3_VALUE, limitsGroup2.getProperty(LIMITS_PROP3_NAME));
    }
    ...
    void testLimitsPropertiesModificationSameOperationalLimits() {
        ...
        OperationalLimitsGroupModificationInfos opLimitsGroupInfos = OperationalLimitsGroupModificationInfos.builder()
            ...
            .currentLimits(CurrentLimitsModificationInfos.builder().permanentLimit(10.0).build())
            .limitsProperties(List.of(new LimitsPropertyInfos(LIMITS_PROP2_NAME, LIMITS_PROP2_VALUE),
                new LimitsPropertyInfos(LIMITS_PROP3_NAME, LIMITS_PROP3_VALUE))).build();
        ...
        assertTrue(limitsGroup1.hasProperty(LIMITS_PROP2_NAME));
        assertTrue(limitsGroup1.hasProperty(LIMITS_PROP3_NAME));
        assertFalse(limitsGroup1.hasProperty(LIMITS_PROP1_NAME));
        assertEquals(LIMITS_PROP2_VALUE, limitsGroup1.getProperty(LIMITS_PROP2_NAME));
        assertEquals(LIMITS_PROP3_VALUE, limitsGroup1.getProperty(LIMITS_PROP3_NAME));

        assertEquals(2, limitsGroup2.getPropertyNames().size());
        assertTrue(limitsGroup2.hasProperty(LIMITS_PROP2_NAME));
        assertTrue(limitsGroup2.hasProperty(LIMITS_PROP3_NAME));
        assertFalse(limitsGroup2.hasProperty(LIMITS_PROP1_NAME));
        assertEquals(LIMITS_PROP2_VALUE, limitsGroup2.getProperty(LIMITS_PROP2_NAME));
        assertEquals(LIMITS_PROP3_VALUE, limitsGroup2.getProperty(LIMITS_PROP3_NAME));
    }
    ...
    void testLimitsPropertiesModificationSameOperationalLimitsReplace() {
        ...
        assertTrue(repLimitsGroup1.hasProperty(LIMITS_PROP2_NAME));
        assertTrue(repLimitsGroup1.hasProperty(LIMITS_PROP3_NAME));
        assertFalse(repLimitsGroup1.hasProperty(LIMITS_PROP1_NAME));
        assertEquals(LIMITS_PROP2_VALUE, repLimitsGroup1.getProperty(LIMITS_PROP2_NAME));
        assertEquals(LIMITS_PROP3_VALUE, repLimitsGroup1.getProperty(LIMITS_PROP3_NAME));
        ...
        assertTrue(repLimitsGroup2.hasProperty(LIMITS_PROP2_NAME));
        assertTrue(repLimitsGroup2.hasProperty(LIMITS_PROP3_NAME));
        assertFalse(repLimitsGroup2.hasProperty(LIMITS_PROP1_NAME));
        assertEquals(LIMITS_PROP2_VALUE, repLimitsGroup2.getProperty(LIMITS_PROP2_NAME));
        assertEquals(LIMITS_PROP3_VALUE, repLimitsGroup2.getProperty(LIMITS_PROP3_NAME));
    }
