...
class CreateVoltageLevelSectionTest extends AbstractNetworkModificationTest {
    ...
    public void checkModification() {
        ...
        String message = assertThrows(NetworkModificationException.class, () -> voltageLevelSectionInfos.toModification().check(network)).getMessage();
        assertEquals("BUSBAR_SECTION_NOT_FOUND : 1 is not the busbar index of the busbar section bbs1 in voltage level v1", message);

        message = assertThrows(NetworkModificationException.class, () -> voltageLevelSectionInfos.toModification().check(network)).getMessage();
        assertEquals("BUSBAR_SECTION_NOT_FOUND : 1 is not the busbar index of the busbar section bbs1 in voltage level v1", message);
        ...
        message = assertThrows(NetworkModificationException.class,
                () -> voltageLevelSectionInfos.toModification().check(network)).getMessage();
