...
class BatteryModificationTest extends AbstractInjectionModificationTest {
    ...
    public void checkModification() {
        ...
        BatteryModificationModel batteryModificationModel = buildModification();
    ...
    @Override
    protected BatteryModificationModel buildModification() {
    ...
    protected void testCreationModificationMessage(ModificationModel modificationModel) throws Exception {
        assertEquals("BATTERY_MODIFICATION", modificationModel.getType().toString());
